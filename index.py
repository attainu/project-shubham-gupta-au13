...
total_occupied_slot = 0          #  Global Var
parking_existence  =  0          #  Global Var
...
if __name__ == "__main__":        # Main Function
    ...
    file_pointer = open("input.txt","r") # open the file in a read mode.
    number_of_lines = len(file_pointer.readlines())  # Find the total number of lines from file.
    file_pointer.seek(0) # Reset the file pointer
